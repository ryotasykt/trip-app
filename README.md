...
* 投稿機能(画像、テキスト投稿)
目的：ユーザーの共有したい情報を発信するためです。

* 投稿一覧表示機能
目的：ユーザーの投稿した情報をひと目で確認するためです。

* 投稿詳細表示機能
目的：ユーザーの投稿した情報の詳細を確認するためです。

* 投稿編集機能
目的：一度投稿した情報を再度編集するためです。

* 投稿削除機能
目的：不要になった投稿を削除するためです。

* コメント機能
目的：投稿に対し、さらに情報を得たい、投稿者とコミュニケーションを取りたいという時にコメントができるようにするためです。

* 投稿検索機能
目的：気になる投稿をキーワードで検索するできるようにするためです。

* いいね機能 
目的：お気に入りの投稿にいいねをつけることができるようにするためです。

* 画像複数投稿機能
目的：複数の画像を同時に投稿できるようにするためです。

* 画像スライド表示機能
目的：画像をスライド表示させることで、投稿を閲覧しやすくするためです。
